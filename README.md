...
The default suggested global shortcuts are `Ctrl+Shift+7` for Play/Pause, `Ctrl+Shift+8` for Previous track, and `Ctrl+Shift+9` for Next track. macOS uses the corresponding Command shortcuts. All seven commands can be rebound in Chrome's shortcut settings.
